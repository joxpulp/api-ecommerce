...
var productclass_1 = require("../persistence/productclass");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, productclass_1.products.get(id)];
                    case 1:
                        singleProduct = _a.sent();
                        if (singleProduct.length === 0) {
                            return [2 /*return*/, res.status(404).json({ error: 'No existe un producto con este id' })];
                        }
                        return [2 /*return*/, res.json({ product: singleProduct })];
                    case 2: return [4 /*yield*/, productclass_1.products.get()];
                    case 3:
                        get = _a.sent();
                        if (get.length === 0) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, productclass_1.products.add(body.title, body.description, body.code, body.price, body.thumbnail, body.stock)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, res.json({ body: body })];
                    case 2: return [2 /*return*/, res.status(404).json({ error: 'Se debe enviar un body con title, description, code, price, thumbnail, stock' })];
                    case 3:
                        error_2 = _a.sent();
                        console.log(error_2);
                        return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        id = req.params.id;
                        body = req.body;
                        return [4 /*yield*/, productclass_1.products.update(id, body.title, body.description, body.code, body.price, body.thumbnail, body.stock)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, productclass_1.products.delete(id)];
                    case 1:
